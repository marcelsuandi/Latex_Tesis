...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|c|r|p{5cm}|}
        ...
        \hline
        Marcel Suandi Tambing & 23524316 & \DTMlangsetup{showdayofmonth=false,showmonthname=true,showyear=true}\today & \\
        \hline
    \end{tabular}
    \caption{Pernyataan Orisinalitas}
    \label{tab:pernyataan_orisinalitas}
\end{table}


Tesis ini diambil dari \autocite{KemhanRI2014,U.S.DepartmentofDefense2019}, \textcite{togaf2020}